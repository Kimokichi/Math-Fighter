...
export default class MathFighterScene extends Phaser.Scene{
    ...
    gameStart(){
      ...
      this.enemy.anims.play('enemy-standby', true)
      // @ts-ignore
      this.resultText = this.add.text(this.gameHalfWidth,200,'0',{fontSize : '40px', fill : 'maroon', fontFamily : 'Arial, sans-serif'})
      // @ts-ignore
      this.questionText = this.add.text(this.gameHalfWidth,100,'0',{fontSize : '40px', fill : 'maroon', fontFamily : 'Arial, sans-serif'})
      this.createButtons()
      this.input.on('gameobjectdown', this.addNumbers, this)
    ...
    addNumbers(pointer,object,event){
